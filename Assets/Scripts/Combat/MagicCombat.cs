...
public class MagicCombat : CombatScript
{
    ...
    public override void Execute()
    {
        ...
        if (m_InputHandler.GetMagic() && /*m_Caster.CharacterStats.CurrentMana > m_MagicSpells[m_Index].manaCost &&*/ m_CastRecently < 1)
        {
            ...
            m_Caster.CharacterStats.CurrentMana -= m_LastSpell.manaCost;
            magic.spellObject = GameObject.Instantiate(m_LastSpell.spellObject);
    ...
    {
        GameObject.Destroy(m_MagicSpellCasts[i].spellObject);
